...
<body>
		...
		<div class="top">
			<div class="topwrap_l">
				<form action="" name="loginform" class="loginform">
					...
					<div>
						<input type="image" src="../../images/loginbtn.jpg"> &nbsp;<a
							href="#"><img src="../../images/zhcbtn.jpg" width="47" height="23">
						</a>
					</div>
				</form>
			</div>
	...
	<div class="logowrap">
		<div class="logo">
			<img src="../../images/logo.jpg"> <img src="../../images/index_17.jpg">
		</div>
		<div class="search">
	...
	<!--end nav-->
	<div class="infonav">
		<img src="../../images/infonavL.jpg" width="2" height="39"
			style="float:left;">
		...
		<img src="../../images/infonavR.jpg" width="2" height="39"
			style="float:right;">
	</div>
	<!--end top-->
	<!--start 备孕-->
	<div class="main">
		<div class="zy-l">
			<img class="byborder" src="../../images/beiyun_03.jpg" width="682" height="10">
		...
		<div class="mainr-tool pk">
			...
			<ul class="zy-tool">
				<li style="margin-left:23px;"><a href="#"><img
						src="../../images/index_36.jpg" width="29" height="27"><span>生辰八字查询</span>
				</a>
				</li>
				<li style="margin-left:23px;"><a href="#"><img
						src="../../images/index_39.jpg" width="29" height="27"><span>安全期计算</span>
				</a>
				</li>
				<li style="margin-left:23px;"><a href="#"><img
						src="../../images/index_43.jpg" width="29" height="27"><span>怀孕日历表</span>
				</a>
				</li>
				<li style="margin-left:23px;"><a href="#"><img
						src="../../images/index_44.jpg" width="29" height="27"><span>胎儿发育图</span>
				</a>
				</li>
				<li style="margin-left:23px;"><a href="#"><img
						src="../../images/index_47.jpg" width="29" height="27"><span>生男生女预测</span>
				</a>
				</li>
				<li style="margin-left:23px;"><a href="#"><img
						src="../../images/index_48.jpg" width="29" height="27"><span>预产期计算器</span>
				</a>
				</li>
				<li style="margin-left:23px;"><a href="#"><img
						src="../../images/index_51.jpg" width="29" height="27"><span>胎儿体重计算</span>
				</a>
				</li>
				<li style="margin-left:23px;"><a href="#"><img
						src="../../images/index_52.jpg" width="29" height="27"><span>身高体重计算</span>
				</a>
				</li>
				<li style="margin-left:23px;"><a href="#"><img
						src="../../images/index_58.jpg" width="29" height="27"><span>宝宝名字测试</span>
				</a>
				</li>
				<li style="margin-left:23px;"><a href="#"><img
						src="../../images/index_56.jpg" width="29" height="27"><span>宝宝免费起名</span>
				</a>
				</li>
			</ul>
		</div>
